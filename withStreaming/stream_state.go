...
// TestStreamState_Internal demonstrates the SDK streaming feature for state by
// creating a Rendering Context with both Model and Error channels.
func TestStreamState_Internal[T stateType](mode ...string) {
	_ = mode
	logger.Info("Entering TestStreamState_Internal")
	...
	logger.Info("Leaving TestStreamState_Internal")
}
...
// TestStreamState calls into _Internal
func TestStreamState() {
	// EXISTING_CODE
	TestStreamState_Internal[*types.State]()
	// EXISTING_CODE
}

// EXISTING_CODE
// TODO: Add streaming examples
// State ([]types.State, *types.MetaData, error) {
// StateCall(val string) ([]types.Result, *types.MetaData, error) {
// EXISTING_CODE
