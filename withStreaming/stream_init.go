...
// TestStreamInit_Internal demonstrates the SDK streaming feature for init by
// creating a Rendering Context with both Model and Error channels.
func TestStreamInit_Internal[T initType](mode ...string) {
	_ = mode
	logger.Info("Entering TestStreamInit_Internal")
	...
	logger.Info("Leaving TestStreamInit_Internal")
}
...
// TestStreamInit calls into _Internal
func TestStreamInit() {
	// EXISTING_CODE
	TestStreamInit_Internal[*types.Message]()
	// EXISTING_CODE
}

// EXISTING_CODE
// TODO: Add streaming examples
// InitAll ([]types.Message, *types.MetaData, error) {
// InitDryRun ([]types.Message, *types.MetaData, error) {
// InitExample(val string) ([]types.Message, *types.MetaData, error) {
// EXISTING_CODE
