...
// TestStreamLogs_Internal demonstrates the SDK streaming feature for logs by
// creating a Rendering Context with both Model and Error channels.
func TestStreamLogs_Internal[T logType](mode ...string) {
	_ = mode
	logger.Info("Entering TestStreamLogs_Internal")
	...
	logger.Info("Leaving TestStreamLogs_Internal")
}
...
// TestStreamLogs calls into _Internal
func TestStreamLogs() {
	// EXISTING_CODE
	TestStreamLogs_Internal[*types.Log]()
	// EXISTING_CODE
}
