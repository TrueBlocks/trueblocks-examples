...
require github.com/TrueBlocks/trueblocks-sdk/v4 v4.2.0

require (
	github.com/Microsoft/go-winio v0.6.2 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20250130023515-f86b9f89cfae // indirect
