...
require github.com/TrueBlocks/trueblocks-sdk/v5 v5.9.1

require (
	github.com/Microsoft/go-winio v0.6.2 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20250928042956-de9ea31404b7 // indirect
