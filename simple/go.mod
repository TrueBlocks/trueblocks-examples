module github.com/TrueBlocks/trueblocks-examples/simple/v6

// Go Version
go 1.25.1

require github.com/TrueBlocks/trueblocks-sdk/v6 v6.4.1

require (
	github.com/Microsoft/go-winio v0.6.2 // indirect
	github.com/TrueBlocks/trueblocks-chifra/v6 v6.4.5 // indirect
