...
require github.com/TrueBlocks/trueblocks-sdk/v5 v5.0.0-20250329002009-c07cbf9fc971

require (
	github.com/Microsoft/go-winio v0.6.2 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20250328223800-50cd5d7a6cb7 // indirect
