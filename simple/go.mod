...
require github.com/TrueBlocks/trueblocks-sdk/v5 v5.3.0

require (
	github.com/Microsoft/go-winio v0.6.2 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20250923033958-180bbc7ebdbd // indirect
